...
public class ServerReflector extends VivecraftReflector {
    ...
    public boolean init() {
        ...
        if(enabled<0)
        {
            ...
            try{
                ...
                BendsLogger.log(Level.INFO,"Vivecraft Forge Extensions detected! Enabling compatability features.");
            }catch (Exception e)
            {
                enabled = -1;
            }
    ...
    public Vec3d getControllerRot(EntityPlayer player, int c) {
        try {
            ...
            BendsLogger.log(Level.SEVERE, "Vivecraft Client: Unknown Error Parsing getControllerRot\n" + e.getMessage());
        }
        return player.getLookVec();
    }
}
